...
from yolo_package.custom_layers import yolov4_neck, yolov4_head, nms
from yolo_package.utils import load_weights, get_detection_data, draw_bbox, voc_ap, draw_plot_func, read_txt_to_list
from yolo_package.config import yolo_config
from yolo_package.loss import yolo_loss
...
class Yolov4(object):
    ...
    def load_model(self, path):
        ...
        self.inference_model = models.Model(self.yolo_model.input,
                                            nms(yolov4_output, self.img_size,
                                                self.num_classes))  # [boxes, scores, classes, valid_detections]
    ...
    def eval_map(self, gt_folder_path, pred_folder_path, temp_json_folder_path, output_files_path):
        ...
        for txt_file in ground_truth_files_list:
            ...
            new_temp_file = os.path.join(temp_json_folder_path,
                                         file_id + "_ground_truth.json")  # TEMP_FILES_PATH + "/" + file_id + "_ground_truth.json"
        ...
        all_gt = copy(gt_counter_per_class['fruit'])
        ...
        with open(output_files_path + "/output.txt", 'w') as output_file:
            ...
            for class_index, class_name in enumerate(gt_classes):
                ...
                # print(fn, tp_val, fp_val)
                precision = tp_val / (tp_val + fp_val)
                recall = tp_val / (tp_val + fn)
